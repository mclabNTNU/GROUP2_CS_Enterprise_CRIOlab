 ...
 * C source code generated on : Thu Mar 09 10:11:03 2017
 *
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (118);/* Number of blocks */
  ctrl_student_HIL_M->Sizes.numBlockIO = (58);/* Number of block outputs */
  ctrl_student_HIL_M->Sizes.numBlockPrms = (419);/* Sum of parameter "widths" */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 66, "ctrl_student_hil/Subtract1", 0, "", offsetof(B_ctrl_student_HIL_T,
    Subtract1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 132, 0 },

  { 67, "ctrl_student_hil/Subtract2", 0, "", offsetof(B_ctrl_student_HIL_T,
    Subtract2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 134, 0 },

  { 68, "ctrl_student_hil/Int1", 0, "", offsetof(B_ctrl_student_HIL_T, Int1)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 136, 0 },

  { 69, "ctrl_student_hil/Integrator", 0, "(1,1)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 138, 0 },

  { 70, "ctrl_student_hil/Integrator", 0, "(1,2)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 140, 0 },

  { 71, "ctrl_student_hil/Integrator", 0, "(1,3)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 142, 0 },

  { 72, "ctrl_student_hil/Integrator", 0, "(1,4)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+3*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 144, 0 },

  { 73, "ctrl_student_hil/Integrator", 0, "(1,5)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+4*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 146, 0 },

  { 74, "ctrl_student_hil/Integrator", 0, "(1,6)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+5*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 148, 0 },

  { 75, "ctrl_student_hil/Integrator", 0, "(1,7)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+6*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 150, 0 },

  { 76, "ctrl_student_hil/Integrator", 0, "(1,8)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+7*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 152, 0 },

  { 77, "ctrl_student_hil/Integrator", 0, "(1,9)", offsetof(B_ctrl_student_HIL_T,
    Integrator)+8*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 154, 0 },

  { 78, "ctrl_student_hil/joystick/Voith Schneider Propeller", 0, "Omega1",
    offsetof(B_ctrl_student_HIL_T, Omega1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 156, 0 },

  { 79, "ctrl_student_hil/joystick/Voith Schneider Propeller", 1, "Omega2",
    offsetof(B_ctrl_student_HIL_T, Omega2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 158, 0 },

  { 80, "ctrl_student_hil/joystick/MATLAB Function1", 0, "u_VSP", offsetof
    (B_ctrl_student_HIL_T, u_VSP)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 160, 0
  },

  { 81, "ctrl_student_hil/joystick/MATLAB Function1", 1, "a_VSP", offsetof
    (B_ctrl_student_HIL_T, a_VSP)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 162, 0
  },

  { 82, "ctrl_student_hil/joystick/MATLAB Function", 0, "u", offsetof
    (B_ctrl_student_HIL_T, u)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 164, 0 },

  { 83, "ctrl_student_hil/joystick/MATLAB Function", 1, "a", offsetof
    (B_ctrl_student_HIL_T, a)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 166, 0 },

  { 84, "ctrl_student_hil/joystick/Bow thruster", 0, "u_BT", offsetof
    (B_ctrl_student_HIL_T, u_BT)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 168, 0
  },

  { 85, "ctrl_student_hil/TANK LIMITS/Tank Limits", 0, "x_d1", offsetof
    (B_ctrl_student_HIL_T, x_d1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 170, 0
  },

  { 86, "ctrl_student_hil/TANK LIMITS/Tank Limits", 1, "M1", offsetof
    (B_ctrl_student_HIL_T, M1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 172, 0 },

  { 87, "ctrl_student_hil/TANK LIMITS/Tank Limits", 2, "s1", offsetof
    (B_ctrl_student_HIL_T, s1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 174, 0 },

  { 88, "ctrl_student_hil/SWITCH", 0, "Eta(1,1)", offsetof(B_ctrl_student_HIL_T,
    Eta)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 176, 0 },

  { 89, "ctrl_student_hil/SWITCH", 0, "Eta(1,2)", offsetof(B_ctrl_student_HIL_T,
    Eta)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 178, 0 },

  { 90, "ctrl_student_hil/SWITCH", 0, "Eta(1,3)", offsetof(B_ctrl_student_HIL_T,
    Eta)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 180, 0 },
  ...
  { 92, "ctrl_student_hil/Noise generator/Sample & hold/MATLAB Function1", 0,
    "output(1,2)", offsetof(B_ctrl_student_HIL_T, output)+1*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 184, 0 },

  { 93, "ctrl_student_hil/Noise generator/Sample & hold/MATLAB Function1", 0,
    "output(1,3)", offsetof(B_ctrl_student_HIL_T, output)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 186, 0 },

  { 94, "ctrl_student_hil/Noise generator/Downsamplesignal/MATLAB Function", 0,
    "count", offsetof(B_ctrl_student_HIL_T, count)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 188, 0 },

  { 95, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,1)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+0*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 190, 0
  },

  { 96, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,2)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+1*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 192, 0
  },

  { 97, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,3)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+2*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 194, 0
  },

  { 98, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,4)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+3*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 196, 0
  },

  { 99, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,5)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+4*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 198, 0
  },

  { 100, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,6)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+5*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 200, 0
  },

  { 101, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,7)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+6*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 202, 0
  },

  { 102, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,8)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+7*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 204, 0
  },

  { 103, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,9)", offsetof
    (B_ctrl_student_HIL_T, Mx1)+8*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 206, 0
  },

  { 104, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 1, "Mx1(1,10)",
    offsetof(B_ctrl_student_HIL_T, Mx1)+9*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2,
    208, 0 },

  { 105, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,1)", offsetof
    (B_ctrl_student_HIL_T, My1)+0*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 210, 0
  },

  { 106, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,2)", offsetof
    (B_ctrl_student_HIL_T, My1)+1*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 212, 0
  },

  { 107, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,3)", offsetof
    (B_ctrl_student_HIL_T, My1)+2*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 214, 0
  },

  { 108, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,4)", offsetof
    (B_ctrl_student_HIL_T, My1)+3*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 216, 0
  },

  { 109, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,5)", offsetof
    (B_ctrl_student_HIL_T, My1)+4*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 218, 0
  },

  { 110, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,6)", offsetof
    (B_ctrl_student_HIL_T, My1)+5*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 220, 0
  },

  { 111, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,7)", offsetof
    (B_ctrl_student_HIL_T, My1)+6*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 222, 0
  },

  { 112, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,8)", offsetof
    (B_ctrl_student_HIL_T, My1)+7*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 224, 0
  },

  { 113, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,9)", offsetof
    (B_ctrl_student_HIL_T, My1)+8*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 226, 0
  },

  { 114, "ctrl_student_hil/DROP DETECTOR/DROP DETECTOR", 2, "My1(1,10)",
    offsetof(B_ctrl_student_HIL_T, My1)+9*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2,
    228, 0 },

  { 115, "ctrl_student_hil/DP Observer", 0, "x_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 230,
    0 },

  { 116, "ctrl_student_hil/DP Observer", 0, "x_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 232,
    0 },

  { 117, "ctrl_student_hil/DP Observer", 0, "x_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 234,
    0 },

  { 118, "ctrl_student_hil/DP Observer", 0, "x_dot(1,4)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+3*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 236,
    0 },

  { 119, "ctrl_student_hil/DP Observer", 0, "x_dot(1,5)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+4*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 238,
    0 },

  { 120, "ctrl_student_hil/DP Observer", 0, "x_dot(1,6)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+5*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 240,
    0 },

  { 121, "ctrl_student_hil/DP Observer", 0, "x_dot(1,7)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+6*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 242,
    0 },

  { 122, "ctrl_student_hil/DP Observer", 0, "x_dot(1,8)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+7*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 244,
    0 },

  { 123, "ctrl_student_hil/DP Observer", 0, "x_dot(1,9)", offsetof
    (B_ctrl_student_HIL_T, x_dot)+8*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 246,
    0 },
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.155";
static char* NI_CompiledModelDateTime = "Thu Mar 09 10:11:02 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.yerror_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.psi_error_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
