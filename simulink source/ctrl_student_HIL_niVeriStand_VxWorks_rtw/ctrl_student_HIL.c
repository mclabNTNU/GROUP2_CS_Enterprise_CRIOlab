...
void ctrl_student_HIL_output(void)
{
  ...
  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_B.Tau[i] = ((R_2[i] + a_1[i]) - (((real_T)b_b[i + 3] *
      ctrl_student_HIL_B.k2 * S_0[1] + ctrl_student_HIL_B.k2 * (real_T)b_b[i] *
      S_0[0]) + (real_T)b_b[i + 6] * ctrl_student_HIL_B.k2 * S_0[2])) -
      rtb_Switch[i];
  }
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlockPrms = (464);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int* TaskSampleHit)
{
  ...
  // Guidance (CASE D)/k2
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.k2, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 52, "ctrl_student_hil/Guidance (CASE D)/k2", 0, "", offsetof
    (B_ctrl_student_HIL_T, k2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 104, 0 },
  ...
  { 58, "ctrl_student_hil/Guidance (CASE D)/Memory1", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory1_k)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    116, 0 },

  { 59, "ctrl_student_hil/Guidance (CASE D)/Memory1", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory1_k)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    118, 0 },

  { 60, "ctrl_student_hil/Guidance (CASE D)/Memory1", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory1_k)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    120, 0 },

  { 61, "ctrl_student_hil/Guidance (CASE D)/Memory2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory2_e)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    122, 0 },

  { 62, "ctrl_student_hil/Guidance (CASE D)/Memory2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory2_e)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    124, 0 },

  { 63, "ctrl_student_hil/Guidance (CASE D)/Memory2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory2_e)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    126, 0 },

  { 64, "ctrl_student_hil/Guidance (CASE D)/Memory3", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory3_l)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    128, 0 },

  { 65, "ctrl_student_hil/Guidance (CASE D)/Memory3", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory3_l)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    130, 0 },

  { 66, "ctrl_student_hil/Guidance (CASE D)/Memory3", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory3_l)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    132, 0 },

  { 67, "ctrl_student_hil/Guidance (CASE D)/s", 0, "", offsetof
    (B_ctrl_student_HIL_T, s)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 134, 0 },

  { 68, "ctrl_student_hil/Int1", 0, "", offsetof(B_ctrl_student_HIL_T, Int1)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 136, 0 },

  { 69, "ctrl_student_hil/Observer (CASE C)/L2", 0, "", offsetof
    (B_ctrl_student_HIL_T, L2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 138, 0 },

  { 70, "ctrl_student_hil/Observer (CASE C)/L1", 0, "", offsetof
    (B_ctrl_student_HIL_T, L1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 140, 0 },

  { 71, "ctrl_student_hil/Observer (CASE C)/L3", 0, "", offsetof
    (B_ctrl_student_HIL_T, L3)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 142, 0 },

  { 72, "ctrl_student_hil/Observer (CASE C)/Subtract", 0, "", offsetof
    (B_ctrl_student_HIL_T, Subtract)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 144,
    0 },

  { 73, "ctrl_student_hil/Observer (CASE C)/Subtract1", 0, "", offsetof
    (B_ctrl_student_HIL_T, Subtract1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    146, 0 },

  { 74, "ctrl_student_hil/Observer (CASE C)/Subtract2", 0, "", offsetof
    (B_ctrl_student_HIL_T, Subtract2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    148, 0 },

  { 75, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    150, 0 },

  { 76, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    152, 0 },

  { 77, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    154, 0 },

  { 78, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,4)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+3*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    156, 0 },

  { 79, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,5)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+4*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    158, 0 },

  { 80, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,6)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+5*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    160, 0 },

  { 81, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,7)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+6*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    162, 0 },

  { 82, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,8)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+7*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    164, 0 },

  { 83, "ctrl_student_hil/Observer (CASE C)/Integrator", 0, "(1,9)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+8*sizeof(real_T), BLOCKIO_SIG, 22, 1, 2,
    166, 0 },

  { 84, "ctrl_student_hil/joystick/L2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_T, L2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    168, 0 },

  { 85, "ctrl_student_hil/joystick/PosXLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 170,
    0 },

  { 86, "ctrl_student_hil/joystick/PosYLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 172,
    0 },

  { 87, "ctrl_student_hil/joystick/PosXRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    174, 0 },

  { 88, "ctrl_student_hil/joystick/PosYRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    176, 0 },

  { 89, "ctrl_student_hil/joystick/ArrowUp", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowUp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 178,
    0 },

  { 90, "ctrl_student_hil/joystick/ArrowDown", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowDown)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    180, 0 },

  { 91, "ctrl_student_hil/joystick/Memory", 0, "", offsetof(B_ctrl_student_HIL_T,
    Memory_f)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 182, 0 },

  { 92, "ctrl_student_hil/joystick/R2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_T, R2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    184, 0 },

  { 93, "ctrl_student_hil/joystick/L1", 0, "", offsetof(B_ctrl_student_HIL_T,
    L1_b)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 186, 0 },

  { 94, "ctrl_student_hil/joystick/R1", 0, "", offsetof(B_ctrl_student_HIL_T, R1)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 188, 0 },

  { 95, "ctrl_student_hil/joystick/ArrowLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    190, 0 },

  { 96, "ctrl_student_hil/joystick/ArrowRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    192, 0 },

  { 97, "ctrl_student_hil/joystick/Voith Schneider Propeller", 0, "Omega1",
    offsetof(B_ctrl_student_HIL_T, Omega1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 194, 0 },

  { 98, "ctrl_student_hil/joystick/Voith Schneider Propeller", 1, "Omega2",
    offsetof(B_ctrl_student_HIL_T, Omega2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 196, 0 },

  { 99, "ctrl_student_hil/joystick/MATLAB Function1", 0, "u_VSP", offsetof
    (B_ctrl_student_HIL_T, u_VSP)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 198, 0
  },

  { 100, "ctrl_student_hil/joystick/MATLAB Function1", 1, "a_VSP", offsetof
    (B_ctrl_student_HIL_T, a_VSP)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 200, 0
  },

  { 101, "ctrl_student_hil/joystick/MATLAB Function", 0, "u", offsetof
    (B_ctrl_student_HIL_T, u)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 202, 0 },

  { 102, "ctrl_student_hil/joystick/MATLAB Function", 1, "a", offsetof
    (B_ctrl_student_HIL_T, a)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 204, 0 },

  { 103, "ctrl_student_hil/joystick/Bow thruster", 0, "u_BT", offsetof
    (B_ctrl_student_HIL_T, u_BT)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 206, 0
  },

  { 104, "ctrl_student_hil/Tank (CASE B)/TANK LIMITS (CASE B)/Tank Limits", 0,
    "x_d1", offsetof(B_ctrl_student_HIL_T, x_d1)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 208, 0 },

  { 105, "ctrl_student_hil/Tank (CASE B)/TANK LIMITS (CASE B)/Tank Limits", 1,
    "M1", offsetof(B_ctrl_student_HIL_T, M1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 210, 0 },

  { 106, "ctrl_student_hil/Tank (CASE B)/TANK LIMITS (CASE B)/Tank Limits", 2,
    "s1", offsetof(B_ctrl_student_HIL_T, s1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 212, 0 },

  { 107, "ctrl_student_hil/SWITCH", 0, "Eta(1,1)", offsetof(B_ctrl_student_HIL_T,
    Eta)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 214, 0 },

  { 108, "ctrl_student_hil/SWITCH", 0, "Eta(1,2)", offsetof(B_ctrl_student_HIL_T,
    Eta)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 216, 0 },

  { 109, "ctrl_student_hil/SWITCH", 0, "Eta(1,3)", offsetof(B_ctrl_student_HIL_T,
    Eta)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 218, 0 },

  { 110, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,1)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+0*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 220, 0 },

  { 111, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,2)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+1*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 222, 0 },

  { 112, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,3)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+2*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 224, 0 },

  { 113, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,4)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+3*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 226, 0 },

  { 114, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,5)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+4*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 228, 0 },

  { 115, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,6)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+5*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 230, 0 },

  { 116, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,7)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+6*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 232, 0 },

  { 117, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,8)",
    offsetof(B_ctrl_student_HIL_T, x_dot)+7*sizeof(real_T), BLOCKIO_SIG, 22, 1,
    2, 234, 0 },

  { 118, "ctrl_student_hil/Observer (CASE C)/DP Observer", 0, "x_dot(1,9)",
  ...
  { 122, "ctrl_student_hil/Noise generator/Downsamplesignal/MATLAB Function", 0,
    "count", offsetof(B_ctrl_student_HIL_T, count)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 244, 0 },

  { 123, "ctrl_student_hil/Guidance (CASE D)/Guidance (Ellipse)", 0, "s_dot",
...
static int NI_SigListSize DataSection(".NIVS.siglistsize") = 159;
...
static long NI_ExtListSize DataSection(".NIVS.extlistsize") = 65;
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 11, "Guidance (CASE D)/k2 ", 0, EXT_IN, 1, 1, 1 },

  { 12, "Guidance (CASE D)/mu1", 0, EXT_IN, 1, 1, 1 },

  { 13, "Observer (CASE C)/L2", 0, EXT_IN, 1, 1, 1 },

  { 14, "Observer (CASE C)/L1", 0, EXT_IN, 1, 1, 1 },

  { 15, "Observer (CASE C)/L3", 0, EXT_IN, 1, 1, 1 },
  ...
  { 19, "joystick/PosXRight", 1, EXT_IN, 1, 1, 1 },

  { 20, "joystick/PosYRight", 1, EXT_IN, 1, 1, 1 },

  { 21, "joystick/ArrowUp", 0, EXT_IN, 1, 1, 1 },

  { 22, "joystick/ArrowDown", 0, EXT_IN, 1, 1, 1 },
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.167";
static char* NI_CompiledModelDateTime = "Thu Mar 23 15:27:42 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_student_HIL_DW.k2_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_student_HIL_DW.k2_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_student_HIL_DW.k2_DWORK2,
        count, 20, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_student_HIL_DW.k2_DWORK2");
    }
  ...
  * clockTicks)
{
  ...
  if (discStates) {
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_DW.integratorresetmodel_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_DW.k2_DWORK1, 0, discStates[idx++],
      0, 0);
    ...
    for (count = 0; count < 17; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_DW.k2_DWORK2, count,
        discStates[idx++], 20, 0);
    }
