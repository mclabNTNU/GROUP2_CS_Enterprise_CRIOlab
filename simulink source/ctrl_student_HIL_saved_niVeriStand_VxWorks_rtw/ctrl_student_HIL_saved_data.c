...
# define ctrl_student_HIL_saved_P      ctrl_student_HIL_saved_P DataSection(".NIVS.defaultparams")
#endif

/*
 * ctrl_student_HIL_saved_data.c
 *
...
P_ctrl_student_HIL_saved_T ctrl_student_HIL_saved_P = {
...
NI_ParamSizeWidth P_ctrl_student_HIL_saved_T_sizes[] DataSection(
  ".NIVS.defaultparamsizes") = {
  { sizeof(P_ctrl_student_HIL_saved_T), 1 },
